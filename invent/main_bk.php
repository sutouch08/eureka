...
<tr>
	...
	<button type='button' id='{{ id }}' class='btn btn-default pop-btn' data-container='body' data-toggle='popover' data-html='true' data-placement='right' data-content='{{{ in_zone }}}'>แสดงที่เก็บ</button>
	</td>
</tr>
{{/if}}
{{/each}}
