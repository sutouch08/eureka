					...
					<td colspan="5" style="line-height:50px;">
						<center>
							<strong>
								...
								รายการ มูลค่ารวม <?php echo number_format($sumtotal_cart,2); ?>
							</strong>
						</center>
					</td>
				</tr>
    ...
    <div class='col-lg-12 col-md-12 col-xs-12 col-sm-12'>
     ...
     <div class='col-lg-12 col-md-12 col-xs-12 col-sm-12'>&nbsp;<!---  Divider  --------------></div>
      <div class='col-lg-2 col-md-3 col-xs-12 col-sm-12'>
				<button type="button" class="btn btn-success btn-block" id="btn_confirm" disabled onclick="confirm_order(<?php echo $id_cart; ?>)">ยืนยันการสั่งซื้อ</button>
			</div>
		<?php endif; ?>
<?php else : ?>
<div class='col-lg-12 col-md-12 col-sm-12 col-xs-12' style='text-align:center;'>
...
function confirm_order(id_cart){
	...
	load_in();
	$.ajax({
		url:'controller/orderController.php?confirm_order',
		type:'POST',
		cache:false,
		data:{
			'id_cart' : id_cart,
